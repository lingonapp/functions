 ...
 * ============
 */
var _b = testUtils_2.projectSetup({}), projectId = _b.projectId, coverageUrl = _b.coverageUrl, rules = _b.rules, generateUid = _b.generateUid;
...
describe("location", function () {
    ...
    describe("create chat message", function () {
        it("should have to be a member in the chat", function () { return __awaiter(void 0, void 0, void 0, function () {
            var adminDb, authedDb, authedChat, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        adminDb = testUtils_1.adminApp(projectId);
                        authedDb = testUtils_2.authedApp(projectId, {
                            uid: VALID_USER_ID
                        });
                    ...
                    case 1:
                        ...
                        authedChat = authedDb
                            ...
                            .collection("messages")
                            .doc();
                        return [4 /*yield*/, testing_1.assertSucceeds(authedChat.set(VALID_CHAT_MESSAGE))];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, authedChat.get()];
                    case 3:
                        data = _a.sent();
